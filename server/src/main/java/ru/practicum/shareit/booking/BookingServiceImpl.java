...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto create(Long userId, NewBooking newBooking) {
        ...
        log.info("Новый запрос на бронирование id:{}, id пользователя:{} id вещи:{}, статус:{}, начало:{}, конец:{} ",
                storedBooking.getId(), storedBooking.getBooker().getId(), storedBooking.getItem().getId(),
                storedBooking.getStatus(), storedBooking.getStart(), storedBooking.getEnd());

        return BookingMapper.toBookingDto(storedBooking);
    }
